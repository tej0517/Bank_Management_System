    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable()) // Disable CSRF for API testing
            .authorizeHttpRequests(authorize -> {
             ...
             // User-only endpoints
                authorize.requestMatchers("/customer/addcustomer/**").hasRole("USER");
                authorize.requestMatchers("/customer/deposit/**").hasRole("USER");
                authorize.requestMatchers("/customer/credit/**").hasRole("USER");
                authorize.requestMatchers("/customer/balance/**").hasRole("USER");
